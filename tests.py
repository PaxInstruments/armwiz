...
print("    - Making temporary directory... ",end="")
sys.stdout.flush()
try:
    temporaryDirectoryPath = armwiz.makeTemporaryDirectory()
except:
...
for libraryToDeploy in libraryDeploymentList:
    try:
        ...
        print("    - Deploying {} to {}/libraries/{}... ".format(thisLibrary.git_name,temporaryProjectRootDirectory,thisLibrary.git_name),end="")
        sys.stdout.flush()
